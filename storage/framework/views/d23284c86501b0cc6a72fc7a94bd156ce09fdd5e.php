...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br>
        <form id="demo-form2" action="<?php echo e(route('category.store')); ?>" class="form-horizontal form-label-left" method="post">
        	<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_projects\ecommerce\resources\views/admin/category/add.blade.php ENDPATH**/ ?>